...
## Description
The Quest Messenger is on track to become the first fully featured, cross-platform, publicly auditable, decentralized, real-time end-to-end encrypted messenger with a feature to exchange goods and services and send payments. The messenger is a [Quest OS Module](https://github.com/QuestNetwork/quest-os-js) which makes use of the [Interplanetary Filesystem](https://ipfs.io) and [IPFS GossipSub](https://blog.ipfs.io/2020-05-20-gossipsub-v1.1/) and [qDesktop](https://github.com/QuestNetwork/qDesktop), our window manager.
...
- [qDesktop](https://github.com/QuestNetwork/qDesktop)
